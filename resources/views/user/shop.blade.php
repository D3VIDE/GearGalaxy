        ...
        <div class="mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div class="relative w-full sm:w-64">
                <div x-data="{ open: false }" class="relative">
                    ...
                    <button @click="open = !open" class="flex items-center justify-between w-full px-4 py-2 text-sm font-medium border border-gray-300 rounded-lg bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <span>
                            @if(request('category'))
                                {{ request('category') }}
                            @else
                    ...
                    <!-- Dropdown menu -->
                    <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 z-10 w-full mt-2 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                        <div class="py-1">
                            <a href="{{ route('shop') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 {{ !request('category') ? 'bg-blue-50 text-blue-600' : '' }}">
                                Semua Kategori
                            </a>
