        ...
        <div class="container mx-auto px-6">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center justify-center space-x-1">
                    ...
                    <a href="{{ route('shop') }}"
                        class="px-4 py-2 text-gray-700 hover:text-indigo-600 font-medium">Shop</a>
                </div>
                    ...
                    <div class="relative">
                        <form action="{{ route('search') }}" method="GET" class="flex-1 max-w-xl mx-4">
                            <div class="relative">
                                ...
                                <button type="submit"
                                    class="absolute right-3 top-2 text-gray-500 hover:text-indigo-600">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" @click.away="open = false" x-transition
                                ...
                                @auth
                                    <a href="/account" class="block px-4 py-2 text-gray-700 hover:bg-indigo-50">My
                                        Account</a>
