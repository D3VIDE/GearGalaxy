    ...
    <nav class="hidden md:block bg-white shadow-md sticky top-0 z-50">
        <div class="container mx-auto px-6">
            <div class="flex justify-between items-center py-4">
                <!-- Logo -->
                <div class="flex items-center space-x-2 text-2xl font-bold text-indigo-600 tracking-wide">
                    ...
                    <!-- Brand Text -->
                    <a href="/" class="text-2xl font-bold text-indigo-600 tracking-wide">
                        GearGalaxy
                    </a>
                </div>
                ...
                <div class="flex items-center space-x-6">
                    <div class="relative hidden lg:block">
                        ...
                        <button class="absolute right-4 top-1/3 transform -translate-y-1/4 text-gray-500">
