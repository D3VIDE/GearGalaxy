            ...
            <table class="min-w-full divide-y divide-gray-200 text-center">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Nama Produk</th>
                        <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Deskripsi</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200" id="productTableBody">
                    @forelse($products as $product)
                        <tr class="product-row">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap product-description">
                                <div class="text-sm text-gray-500">{{ Str::limit($product->product_description, 50, '...') }}</div>
                            </td>
